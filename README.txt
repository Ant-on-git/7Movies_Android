...
в качестве кнопки доб\убр в избранное будет звездочка внизу постера. серого цвета - нет в избранном. оранжевого - есть.
Посмотреть встренные в андроид кнопки  и тд можно в макете (layout) - attribute - srcCompat - в поиске пишешь что надо



Далее сделалали активити для избранных фильмов
Все так же как в мэинактивити, только запрос не через ретрофит в сеть, а в локальную бд через рум.
те же карточки как в MainActivity, тот же RecyclerView. Адаптер использовали тот, что уже был - MainAdapter
